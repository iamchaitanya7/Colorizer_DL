...
def colorizer(img):
    ...
    prototxt = r"Colorizer-master\models\models_colorization_deploy_v2.prototxt"
    model = r"Colorizer-master\models\colorization_release_v2.caffemodel"
    points = r"Colorizer-master\models\pts_in_hull.npy"
